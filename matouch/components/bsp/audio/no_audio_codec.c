...
void audio_simplex_init(audio_handle_t *handle, audio_cfg_t *config) 
{
    audio_handle_t audio_handle = (audio_handle_t)malloc(sizeof(struct audio_t));
...
void audio_duplex_init(audio_handle_t *handle, audio_cfg_t *config) 
{
    audio_handle_t audio_handle = (audio_handle_t)malloc(sizeof(struct audio_t));
    assert(audio_handle != NULL);
